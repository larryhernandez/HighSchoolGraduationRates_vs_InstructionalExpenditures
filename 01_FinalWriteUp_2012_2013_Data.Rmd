...
source("E:/Math/STAT_333_AppliedRegression/Project/R_code/load_libraries_functions.R")
...
predictors = c("leaid12","FIPST","acgr","income","StudentTeacher","InstrExpend","pctFedRevToTotal","pctInstrExpOfDaily","SSvcOfDayCost", "UrbanLocale","Lunch","pctELL","under_minority","Latitude","Longitude")

# Extract predictors of interest, keeping only the complete cases
cleaned_ed_data = na.omit(ed_data[,predictors])

# Divide the data set into (1) training set and (2) validation set
set.seed(1)
proportion_of_data_as_training = 0.20
indices_for_training = get_indices_for_training_set(cleaned_ed_data, proportion_of_data_as_training)
